...
namespace NKnife.TDMS.Externals
{
    internal class TypeSafeMethod : DDC
    {
        ...
        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_ReplaceDataValuesUInt8(IntPtr channel,
                                                            UIntPtr indexOfFirstValueToReplace,
                                                            byte[] values,
                                                            UIntPtr numValues);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_ReplaceDataValuesInt16(IntPtr channel,
                                                            UIntPtr indexOfFirstValueToReplace,
                                                            short[] values,
                                                            UIntPtr numValues);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_ReplaceDataValuesInt32(IntPtr channel,
                                                            UIntPtr indexOfFirstValueToReplace,
                                                            int[] values,
                                                            UIntPtr numValues);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_ReplaceDataValuesFloat(IntPtr channel,
                                                            UIntPtr indexOfFirstValueToReplace,
                                                            float[] values,
                                                            UIntPtr numValues);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_ReplaceDataValuesDouble(IntPtr channel,
                                                             UIntPtr indexOfFirstValueToReplace,
                                                             double[] values,
                                                             UIntPtr numValues);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_ReplaceDataValuesString(IntPtr channel,
                                                             UIntPtr indexOfFirstValueToReplace,
                                                             string[] values,
                                                             UIntPtr numValues);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetDataValuesUInt8(IntPtr channel,
                                                        UIntPtr indexOfFirstValueToGet,
                                                        UIntPtr numValuesToGet,
                                                        byte[] values);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetDataValuesInt16(IntPtr channel,
                                                        UIntPtr indexOfFirstValueToGet,
                                                        UIntPtr numValuesToGet,
                                                        short[] values);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetDataValuesInt32(IntPtr channel,
                                                        UIntPtr indexOfFirstValueToGet,
                                                        UIntPtr numValuesToGet,
                                                        int[] values);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetDataValuesFloat(IntPtr channel,
                                                        UIntPtr indexOfFirstValueToGet,
                                                        UIntPtr numValuesToGet,
                                                        float[] values);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetDataValuesDouble(IntPtr channel,
                                                         UIntPtr indexOfFirstValueToGet,
                                                         UIntPtr numValuesToGet,
                                                         double[] values);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetDataValuesString(IntPtr channel,
                                                         UIntPtr indexOfFirstValueToGet,
                                                         UIntPtr numValuesToGet,
                                                         IntPtr[] values);
        ...
        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetFilePropertyString(IntPtr file,
                                                           string property,
                                                           [Out] char[] value,
                                                           UIntPtr valueSize);
        ...
        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelGroupPropertyInt16(IntPtr channelGroup, string property, out short value);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelGroupPropertyInt32(IntPtr channelGroup, string property, out int value);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelGroupPropertyFloat(IntPtr channelGroup, string property, out float value);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelGroupPropertyDouble(IntPtr channelGroup, string property, out double value);
        ...
        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelPropertyString(IntPtr channel,
                                                              string property,
                                                              [Out] char[] value,
                                                              UIntPtr valueSize);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetFilePropertyNameFromIndex(IntPtr file,
                                                                  UIntPtr index,
                                                                  [Out] char[] propertyName,
                                                                  UIntPtr propertyNameSize);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetFilePropertyNameLengthFromIndex(IntPtr file,
                                                                        UIntPtr index,
                                                                        out UIntPtr propertyNameLength);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelGroupPropertyNameFromIndex(IntPtr channelGroup,
                                                                          UIntPtr index,
                                                                          [Out] char[] propertyName,
                                                                          UIntPtr propertyNameSize);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelGroupPropertyNameLengthFromIndex(
            IntPtr channelGroup,
            UIntPtr index,
            out UIntPtr propertyNameLength);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelPropertyNameFromIndex(IntPtr channel,
                                                                     UIntPtr index,
                                                                     [Out] char[] propertyName,
                                                                     UIntPtr propertyNameSize);

        [DllImport(Dll, CallingConvention = CallingConvention.StdCall)]
        public static extern int DDC_GetChannelPropertyNameLengthFromIndex(IntPtr channel,
                                                                           UIntPtr index,
                                                                           out UIntPtr propertyNameLength);
    }
}